...
// Jawne nadpisanie schemów ustawionych przez AddIdentity (cookie) w warstwie infrastruktury
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Typer API", Version = "v1" });
